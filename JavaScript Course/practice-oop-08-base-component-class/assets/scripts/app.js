...
class Tooltip extends Component {
	constructor(closeNotifierFunction, text, hostElementIs) {
		super(hostElementIs);
...
class App {
	static init() {
		...
		const timerId = setTimeout(this.runAnalytics, 3000);
		const analyticsButton = document.getElementById('stop-analytics-btn');
