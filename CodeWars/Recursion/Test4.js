...
function divideStrings(a, b) {
	...
	return [
		convertBinStringToDec(val, intTable),
		convertBinStringToDec(rem, intTable)
	];
}
...
//1001 1101 1101 01
console.log(divideStrings('10101', '100'));
console.log(divideStrings('10101', '1010'));
console.log(divideStrings('10101', '111'));
